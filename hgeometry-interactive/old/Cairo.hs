...
drawDropShadow =
  withRadialPattern 0.55 0.55 0.25 0.5 0.5 0.525 $ \pat -> do
    patternAddColorStopRGBA pat 0    0     0     0     0.811
    patternAddColorStopRGBA pat 0.64 0.345 0.345 0.345 0.317
    patternAddColorStopRGBA pat 0.84 0.713 0.713 0.713 0.137
    patternAddColorStopRGBA pat 1    1     1     1     0
    patternSetFilter pat FilterFast
    setSource pat
    arc 0.5 0.5 (142/150) 0 (pi*2)
    fill

drawClockFace True =
  withLinearPattern 0.5 0 0.5 1 $ \pat -> do
    patternAddColorStopRGB pat 0 0.91 0.96 0.93
    patternAddColorStopRGB pat 1 0.65 0.68 0.68
    patternSetFilter pat FilterFast
    setSource pat
    translate 0.5 0.5
...
drawInnerShadow = do
  ...
  clip
  withRadialPattern 0.3 0.3 0.1 0 0 0.95 $ \pat -> do
    patternAddColorStopRGBA pat 0    1     1     1     0
    patternAddColorStopRGBA pat 0.64 0.713 0.713 0.713 0.137
    patternAddColorStopRGBA pat 0.84 0.345 0.345 0.345 0.317
    patternAddColorStopRGBA pat 1    0     0     0     0.811
    patternSetFilter pat FilterFast
    setSource pat
    arc 0 0 (142/150) 0 (pi*2)
    fill
...
drawFrame True = do
  save
  withRadialPattern (-0.1) (-0.1) 0.8 0 0 1.5 $ \pat -> do
    patternAddColorStopRGB pat 0   0.4  0.4  0.4
    patternAddColorStopRGB pat 0.2 0.95 0.95 0.95
    patternSetFilter pat FilterFast
    setSource pat
    setLineWidth (10/75)
    arc 0 0 (142/150) 0 (pi*2)
  ...
  withRadialPattern (-0.1) (-0.1) 0.8 0 0 1.5 $ \pat -> do
    patternAddColorStopRGB pat 0   0.9  0.9  0.9
    patternAddColorStopRGB pat 0.2 0.35 0.35 0.35
    patternSetFilter pat FilterFast
    setSource pat
    setLineWidth (10/75)
