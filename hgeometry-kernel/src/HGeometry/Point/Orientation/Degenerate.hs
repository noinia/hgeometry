...
sortAround   :: (Ord r, Num r, Point_ point 2 r, OptCVector_ 2 r)
             => point -> [point] -> [point]
...
ccwCmpAround :: (Num r, Ord r, Point_ point 2 r, OptCVector_ 2 r)
...
-- respect to the positive x-axis.
cwCmpAround :: (Num r, Ord r, Point_ point 2 r, OptCVector_ 2 r)
            => point -> point -> point -> Ordering
...
insertIntoCyclicOrder   :: (Ord r, Num r, Point_ point 2 r, OptCVector_ 2 r)
                        => point -> point
