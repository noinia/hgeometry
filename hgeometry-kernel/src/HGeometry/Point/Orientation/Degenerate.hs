...
-- ccw p q r = CCWWrap $ z `compare` 0 -- Comparing against 0 is bad for numerical robustness.
     ...
     where
      ...
      --  _z             = ux * vy - uy * vx
-- {-# SPECIALIZE INLINE
--      ccw :: (Ord r, Num r, OptConstructableVector_ 2 r, Metric_ (VectorFamily 2 r))
...
sortAround   :: (Ord r, Num r, Point_ point 2 r, OptConstructableVector_ 2 r)
             => point -> [point] -> [point]
...
ccwCmpAround :: (Num r, Ord r, Point_ point 2 r, OptConstructableVector_ 2 r)
...
-- respect to the positive x-axis.
cwCmpAround :: (Num r, Ord r, Point_ point 2 r, OptConstructableVector_ 2 r)
            => point -> point -> point -> Ordering
...
insertIntoCyclicOrder   :: (Ord r, Num r, Point_ point 2 r, OptConstructableVector_ 2 r)
                        => point -> point
