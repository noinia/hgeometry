...
import HGeometry.LineSegment.Optimal
...
instance (Num r, Ord r, OptCVector_ 2 r, OptCVector_ 2 point
         , Point_ point 2 r
...
instance (Fractional r, Ord r, OptCVector_ 2 r, OptCVector_ 2 point
         , Point_ point 2 r
